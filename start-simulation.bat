...
echo.
echo Fábrica 24 V simulada. O Mosquitto local deve estar ativo em 127.0.0.1:1883.
echo Cenário configurado por SIMULATION_SCENARIO em gateway\.env.
echo Pressione Ctrl+C para encerrar.
echo.
call npm --prefix gateway run simulation
